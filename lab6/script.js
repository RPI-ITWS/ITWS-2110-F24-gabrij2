...
function displayResults(results, isTroyDay, troyDayPercentage, quote) {
  ...
  const troyDayResult = isTroyDay ? "It's a Troy Day!" : "Not a Troy Day!";
  resultContainer.innerHTML = `<strong id="result">${troyDayPercentage}%</strong>
  <p id="result-text">${troyDayResult}</p>`;
}
